...
class CSCPickerState extends State<CSCPicker> {
  ...
  ///
  /// Host apps should register `assets/csc_country.json` (see splukk `pubspec.yaml`).
  /// Falls back to the legacy package path used by pub.dev releases.
  Future<dynamic> getResponse() async {
    const paths = <String>[
      'assets/csc_country.json',
    ...
    throw FlutterError(
      'CSCPicker: could not load country JSON (tried ${paths.join(", ")}). '
